...
package com.simple.gradleplugin.utils;
...
public class AssetsUtil {
    ...
    public static String getResourceString(ClassLoader classLoader, String fileName) {
        InputStream inputStream = null;
        try {
    ...
    public static JSONObject jsonObjectFromAssets(Context context, String fileName) throws JSONException {
    ...
    public static JSONArray jsonArrayFromAssets(Context context, String fileName) throws JSONException {
        String result = getStringFromAsset(context, fileName);
